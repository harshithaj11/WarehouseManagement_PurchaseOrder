    ...
    public class PurchaseOrdController : ControllerBase
    {
        ...
        public IActionResult Get(long Id)
        {
            ...
            if (purchases.Count == 0)
                return NotFound();
            var dtos = from purchase in purchases
                       select new GetByIdDTO(purchase.Id, purchase.Product.ProductName,purchase.Product.ProductBrand,purchase.Product
                       .Price,purchase.DateOfPurchase, purchase.Qty, purchase.Supplier.Name,purchase.Supplier.Address,purchase.Supplier.Email,purchase.Supplier.PhoneNumber);
